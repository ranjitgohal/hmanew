...
<<<<<<< HEAD
       echo "<div><p> <b>Time</b>							<b style = 'position:relative;left:80px;'>BP</b>
								<b style = 'position:relative;left:100px;'>HB</b>
								<b style = 'position:relative;left:130px;'>Action</b></p></div>";
                                
                                echo "<div>";
                                echo "<p>$strDateTime</p>";
							echo "<p style ='position:absolute;left:120px;top:58px;'>$strbp</p>";
								 echo "<p style ='position:absolute;left:155px;top:58px;'>$strhb</p>";
