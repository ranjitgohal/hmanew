    ...
    <body>
        <center>
            <?php
                ...
                /*
                $name = isset($_GET['dName']) ? $_GET['dName'] : "";
                $id = isset($_GET['dId']) ? $_GET['dId']: 0;
                $type = isset($_GET['dType']) ? $_GET['dType']: "";
                */
            ...
            <div class = "content">
                ...
                <div class = "logout">
                    <p>
                        <!--<a href = "activities.php?<?php echo "name=$name&id=$id&type=$type&back";?>">Back</a>&nbsp;|&nbsp;-->
                ...
                <?php
                    ...
                    if(count($arUnreadMessage))
                    {
                        ...
                        echo "<p style = 'position:relative;top:-30px;left:50px;font-weight:bold;'>[ $unread new $str ]</p>";
                    }               
                    ...
                    if(count($arMessage))
                    {
                        ...
                        echo "<div class= 'message_box'>";
                            ...
                            foreach ($arMessage as $row) 
                            {
                                ...
                                /*
                                $action = $action."<a href = 'doctor_view_message.php?dName=$name&dId=$id&dType=$type&discId={$row['discussionId']}"."'>View</a>&nbsp;|&nbsp;";
                                $action = $action."<a onclick = 'return confirmDeletion();' href = '".$_SERVER['PHP_SELF']."?dName=$name&dId=$id&dType=$type&discId={$row['discussionId']}&del"."'>Delete</a><br/>";
                                */
                                $action = $action."<a href = 'doctor_view_message.php?discId={$row['discussionId']}"."'>View</a>&nbsp;|&nbsp;";
